  ...
  return (
    ...
    <section className=" relative w-full min-h-h90">
      <article className=" S768:w-w95 m-auto">
        ...
        <div className="  S960:w-[95%] m-auto absolute bottom-0 left-0 right-0 w-full h-24 bg-gray-500/40 backdrop-blur-3xl flex items-center justify-end text-[2.4rem] pr-4 overflow-x-hidden">
